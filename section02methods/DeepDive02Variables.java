...
public class DeepDive02Variables
{
  ...
  @Test
  public void amountOfSlicesOfCake() throws Exception
  {
    int slicesOfCake = 8;
    giveCake();
    slicesOfCake = slicesOfCake / 4;
    Assert.assertEquals(slicesOfCake, 2);
  }
  @Test
  public void methodsReturnValuesAndVariablesExistWithinMeathods() throws Exception
  {
    String exam = "basket";
    exam = life();
    Assert.assertEquals(exam, "ball");
  }
  public String life()
  {
    return "ball";
